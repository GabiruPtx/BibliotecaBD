...
public class TelaCadastroUsuarioExterno extends javax.swing.JFrame {

    public TelaCadastroUsuarioExterno() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel14.setText("CADASTRO DE USUÁRIO EXTERNO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroUsuarioExterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroUsuarioExterno().setVisible(true);
            }
        });
    }
